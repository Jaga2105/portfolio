...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 px-4 md:px-10 lg:px-20  bg-bodyColor mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
      <div>
